...
var busRouteSD = require('./routes/busRouteSDRoute');
var drivermonitor = require('./routes/driverMonitor');
...
var terminalemployeLog = require('./routes/terminalEmployeeLog')
var terminalEmployee = require('./routes/terminalEmployeeroute');
...
app.use('/drivermonitor', drivermonitor);
app.use('/geofence', geofence);
//app.use('/busTracking', busTracking);
app.use('/log',terminalemployeLog);	
app.use('/auth',terminalEmployee);	

app.use('/busrouteSD',busRouteSD);
